    ...
    return (
        <>
            ...
            <div className="bg-[#30252d] min-h-[calc(100vh-8rem)] grid grid-cols-10">
                <div
                    className="text-white col-[2/10] row-[1] place-content-center z-50 flex flex-col gap-3 animate-fade-up
"
                >
                    ...
                    hover:bg-[#cfb0e8] transition max-lg:text-sm slash-r  text-center flex items-center"
                    ...
                    hover:bg-gray-700 transition max-lg:text-sm slash-l  text-center flex items-center"
                            href=""
                        >
                            Sponsor Us
                        </a>
